...
{
    if (_viewForInteraction && [_viewForInteraction.gestureRecognizers containsObject:_pinchRecognizer])
    {
        [_viewForInteraction removeGestureRecognizer:_pinchRecognizer];
    }
